                    ...
                    while (game_screen.isOpen())
                    {
                        ...
                        while (game_screen.pollEvent(event2))
                        {
                            ...
                            if (sf::Mouse::isButtonPressed(sf::Mouse::Left))
                            {
                                ...
                                cout << mouse2_position.x << " " << mouse2_position.y << endl;
                                if (option_selector2(mouse2_position.x, mouse2_position.y) == 3)
                                {
                                ...
                                else if (option_selector2(mouse2_position.x, mouse2_position.y) == 4)
                                {
                                    goto replay;
                                }
                            }
